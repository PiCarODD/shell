...
<!DOCTYPE html><html>
    <head>
    <title>#OP_Bengali</title>
    <meta http-equiv="Content-Type" content="text/html; charset=gb2312">
    <script type="text/javascript" src="https://www.bkkgems.com/admin/ug1.js" ></script>
    ...
    <center><img src="https://i.imgur.com/W4t6Iiv.jpg"></center>
    <br>
    <h2 id="h1">Union Of Underground Myanmar Hackers</h1>
    </br>
    <h2 id="h2">We Are Myanmar,We Are The Power</h2>
    <h3 id="h3"><br></h3>
    <h4 id="h4"> #OP_Bengali
    
    <br>Bengli issue had been very much concerned issue for our country. As, we, Myanmar are peacefully living people that we strongly know and believe that we are not doing ethnic cleaning but the news say (without any prove). Bengali are not citizen of Myanmar and they are NOT included in Myanmar's National races. As they are called "Bengali", they are the citizens of Bangladesh. But Bengalidesh keep telling that "Bengali" are citizen and race of Myanmar. 

Because of "Bengali" Terrorists who attacked Myanmar Police Forces, many of Police Officers were killed. UN is also putting pressure on Myanmar Government. While we, Myanmar, are not doing ethnic cleaning but preventing our homeland from being devoured by "Bengali"; in turn of Bangladesh, we are not sure if UN and associated countries are INTENTIONALLY making it happen or not.

So, we, hereby, doing this "#OP Bangladesh 2019" to spread the world that we are being devoured by "Bangali", who are NOT Myanmar's National Race nor citizen. This will NOT be racial or religious attack. This will be the attack to let the world know the truth inside Myanmar.

In our country, there are many religions living together with their own devotions. We want to make it clear that truly give respect to their own belief on their specific religion. So, IF "Bengali" are not Muslims or any religion, we will do the attack; which means, our attacks will NOT be based on Religion. We fight for our mother land. We fight for our own country..</h4>
    <br><br><br><br><br><br><br><br>
    <footer 
    id="det" style="position:fixed; left:0px; right:0px; bottom:0px; background:rgb(0,0,0); text-align:left; border-top: 1px solid #58FAF4; border-bottom: 1px solid #58FAF4"><font size=3 face="Cooper Black">
    <font color="yellow"><b>Union Of </font><font color="green">Underground</font> <font color="red">Myanmar Hackers</font><font color="gray"> Greetz To : </b></font>
    <marquee scrollamount="4" bgcolor="#000000" width="75%"><span class="a"> || All Hacking Team || Myanmar Citizen And You!!! || </span></marquee></footer>
   ...
   <source src="https://ia800807.us.archive.org/8/items/MyanmarOpSong_201709/Myanmar%20%23Op%20Song.mp3" type="audio/mp3">
</audio></body>
    </html>
